...
# 10 "pan.m"
 ...
 case 0:
  return 0;
 case 1: printf("generic 'goto' or 'skip'\n");
  
  _m = 3; goto P999;
 case 2: printf("generic 'else'\n");
  
  if (trpt->o_pm&1) return 0;
  _m = 3; goto P999;


 case 3: printf("CLAIM never_0, STATE 1 - example.pml:23 - [((x<4))]\n");
# 36 "pan.m"
...
# 67 "pan.m"
  ...
  if (!((now.x<4)))
   return 0;
  _m = 3; goto P999;
 case 5: printf("CLAIM never_0, STATE 11 - example.pml:30 - [-end-]\n");
# 88 "pan.m"
...
# 93 "pan.m"
 ...
 case 6: printf("PROC B, STATE 1 - example.pml:16 - [(!((x%2)))]\n");
 
  reached[1][1] = 1;
  if (!( !((now.x%2))))
   return 0;
  _m = 3; goto P999;
 case 7: printf("PROC B, STATE 2 - example.pml:16 - [x = (x/2)]\n");
  ...
  ;
  _m = 3; goto P999;
 case 8: printf("PROC B, STATE 6 - example.pml:18 - [-end-]\n");
 ...
 case 9: printf("PROC A, STATE 1 - example.pml:9 - [((x%2))]\n");
 
  reached[0][1] = 1;
  if (!((now.x%2)))
   return 0;
  _m = 3; goto P999;
 case 10: printf("PROC A, STATE 2 - example.pml:9 - [x = ((3*x)+1)]\n");
  ...
  ;
  _m = 3; goto P999;
 case 11: printf("PROC A, STATE 2 - example.pml:9 - [x = ((3*x)+1)]\n");
